...
describe("idempotency-http-wrapper", () => {
  ...
  describe("dynamoDB", () => {
    ...
    it.skip("Should ignore the idempotency when the header is empty and fallback is disabled", async () => {
      // Given
      const endpoint = faker.internet.url();
      const result = { word: faker.random.word() };
      const internalHandler = jest.fn().mockReturnValue(result);
    ...
    it.skip("Should apply the default TTL", async () => {
      // Given
      const endpoint = faker.internet.url();
      const requestId = faker.random.uuid();
      const result = { word: faker.random.word() };
    ...
    it.skip("Should ignore the request when already called using the request id", async () => {
      // Given
      const endpoint = faker.internet.url();
      const requestId = faker.random.uuid();
    ...
    it.skip("Should ignore the request when already called using the header id", async () => {
      // Given
      const endpoint = faker.internet.url();
      const requestId = faker.random.uuid();
      const internalHandler = jest.fn();
    ...
    it.skip("Should ignore the request when already called using the header id with fallback enabled", async () => {
      // Given
      const endpoint = faker.internet.url();
      const requestId = faker.random.uuid();
      const internalHandler = jest.fn();
